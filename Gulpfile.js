...
gulp.task("watch", function () {
  ...
  gulp.watch([PATHS.srcpath + "/sass/*.scss"], gulp.series("sass"));
  gulp.watch([PATHS.output + "/assets/css/*.css"], gulp.series("minifycss"));
...
gulp.task("minifycss", () => {
  return gulp
    ...
    .pipe(gulp.dest(PATHS.output + "/assets/css/min/"));
});
